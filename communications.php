    ...
    <div class="admin-dashboard">
        ...
        <main class="content">
            <form action="" method="post">
                ...
                ?>
                <div class="actions">
                    <a href="?view_history=true" class="view-history">View Communication History</a>
                </div>
            </form>
                ...
                if ($history_result && mysqli_num_rows($history_result) > 0) {
                    ...
                    while ($history = mysqli_fetch_assoc($history_result)) {
                        echo "<div class='message-tile'>
                                ...
                                <p><strong>Message:</strong> " . $history['COMMENTS'] . "</p>
                                <p><strong>Sender:</strong> " . $history['SENDER_TYPE'] . "</p>
                                <p><strong>Status:</strong> " . ($history['READ1'] ? "Read" : "Unread") . "</p>
                                <p><strong>Created At:</strong> " . $history['CREATED_AT'] . "</p>
                              </div>";
                    }
                } else {
